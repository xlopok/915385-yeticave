...
VALUES
    ...
    ("Крепления Union Contact Pro 2015 года размер L/XLа","Не вылетишь, крепят намертво", 8000, 500, 3, 4, 2, "lot-3.jpg", "2020-01-01"),
    ("Ботинки для сноуборда DC Mutiny Charocalа","Тепло, надежно, леопардово", 10999, 1000, 4, null, 3, "lot-4.jpg", "2020-01-01"),
    ("Куртка для сноуборда DC Mutiny Charocalа","Яркая и теплая куртка", 7500, 300, 1, 3, 4, "lot-5.jpg", "2020-01-01"),
